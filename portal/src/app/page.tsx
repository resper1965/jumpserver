      ...
      <header className="sticky top-0 z-10 bg-white/90 dark:bg-gray-950/90 backdrop-blur-sm border-b border-gray-200 dark:border-gray-800">
        <div className="container mx-auto px-4 py-2 flex justify-between items-center">
          ...
          <div className="flex-1 flex gap-2 justify-end">
            <ModeToggle />
            <Button
              onClick={() => router.push('https://github.com/resper1965/jumpserver')}
            >
      ...
      <main className="flex-grow flex flex-col justify-center items-center px-4 py-4 md:py-8">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            >
              <h1 className="text-4xl md:text-6xl font-stretch-110% -tracking-tighter text-gray-900 dark:text-white text-center">
                Ionic Health · LVHN Jumper Server Documentation
              </h1>
            </motion.div>
            <motion.p
              ...
              className="text-shadow-xs mt-6 text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto"
            >
              Centralized source of truth for the LVHN jumper server program including architecture, procedures,
              security controls, and evidence requirements maintained by Ionic Health.
            </motion.p>
          </div>
          ...
          >
            <Button
              className="px-6 py-3"
              variant={'primary'}
              onClick={() => router.push('/docs/overview/project-proposal')}
              size={'md'}
            >
              Get Started
            </Button>
